...
const schema = {
  ...
  MessageElement: {
    ...
    payload(...args) {
      ...
      const schemaFormat = (0, _ramda.defaultTo)(_mediaTypes.default.latest(), (_messageElement$schem = messageElement.schemaFormat) === null || _messageElement$schem === void 0 ? void 0 : _messageElement$schem.toValue());
