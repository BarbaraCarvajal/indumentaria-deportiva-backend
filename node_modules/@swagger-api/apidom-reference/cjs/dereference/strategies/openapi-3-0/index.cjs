...
const OpenApi3_0DereferenceStrategy = (0, _stampit.default)(_DereferenceStrategy.default, {
  init() {
  ...
  methods: {
    canDereference(file) {
      ...
      return (0, _apidomNsOpenapi.isOpenApi3_0Element)((_file$parseResult = file.parseResult) === null || _file$parseResult === void 0 ? void 0 : _file$parseResult.api);
    },
...
var _default = OpenApi3_0DereferenceStrategy;
