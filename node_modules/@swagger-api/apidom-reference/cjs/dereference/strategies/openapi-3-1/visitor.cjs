...
var _index = require("./selectors/$anchor/index.cjs");
var _index2 = require("./selectors/uri/index.cjs");
var _index3 = require("../../../util/errors/index.cjs");
var url = _interopRequireWildcard(require("../../../util/url.cjs"));
var _index4 = _interopRequireDefault(require("../../../parse/index.cjs"));
...
var _EvaluationJsonSchemaUriError = _interopRequireDefault(require("./selectors/uri/errors/EvaluationJsonSchemaUriError.cjs"));
    ...
    async SchemaElement(referencingElement, key, parent, path, ancestors) {
      ...
      try {
        if (isUnknownURI || isURL) {
          ...
          referencedElement = (0, _index2.evaluate)(selector,
          // @ts-ignore
        ...
        if (isURL && error instanceof _EvaluationJsonSchemaUriError.default) {
          if ((0, _index.isAnchor)((0, _index.uriToAnchor)($refBaseURI))) {
            ...
            referencedElement = (0, _index.evaluate)(selector,
            // @ts-ignore
            (0, _util.maybeRefractToSchemaElement)(reference.value.result));
          } else {
            // we're assuming here that we're dealing with JSON Pointer here
      ...
      const mergedResult = new _apidomNsOpenapi.SchemaElement(
      // @ts-ignore
      [...referencedElement.content], referencedElement.meta.clone(), referencedElement.attributes.clone());
